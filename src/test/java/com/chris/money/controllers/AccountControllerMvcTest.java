...
public class AccountControllerMvcTest {
    ...
    void testCreateAccount() throws Exception {
        AccountCreateRequest request = new AccountCreateRequest("12345678", 1000.0);
        Long accountId = 1L;
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/accounts").contentType("application/json")
                .content("{ \"accountNumber\": \"12345678\", \"balance\": 1000.0 }"))
    ...
    void testCreateAccount_InvalidRequest() throws Exception {
        // Test creating an account with invalid request (e.g., missing accountNumber)
        mockMvc.perform(MockMvcRequestBuilders.post("/accounts").contentType("application/json")
